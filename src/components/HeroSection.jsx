  ...
  return (
      <div className=' w-[375px] h-fit  mx-auto  relative '>
        <div className='w-[344px] h-[344px]  absolute top-[249px] left-[16px] '>
          ...
          <Image src={Img3} alt="Img3" className=' absolute top-[35px] left-[31px]'/>
          <Image src={Img2} alt="Img2" className=' absolute top-[64px] left-[58px]'/>
          <Image src={Img1} alt="img1" className=' absolute top-[98px] left-[88px]'/>
          <Image src={circle} alt="circle" className=' absolute top-[128px] left-[117px]'/>
          <Image src={Bell} alt="bell" className=' absolute top-[146px] left-[135px]'/>
        </div>
